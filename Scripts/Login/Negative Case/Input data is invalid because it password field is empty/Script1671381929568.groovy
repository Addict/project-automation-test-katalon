...
//WebUI.setEncryptedText(findTestObject('null'), 'GCkvkrKjV5F1CWbwI7RntA==')
WebUI.click(findTestObject('Object Repository/Login/button_Log in'))

WebUI.verifyElementPresent(findTestObject('Login/Error Message/div_Error The password field is empty'), 0)
